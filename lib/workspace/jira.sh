...
jira -url $_JIRA_URL -credentials-username ${_JIRA_SECRET_KEY}/username -credentials-password ${_JIRA_SECRET_KEY}/password $_JIRA_SUB_COMMAND -i $_JIRA_TICKET $_JIRA_SUB_COMMAND_ARGS
